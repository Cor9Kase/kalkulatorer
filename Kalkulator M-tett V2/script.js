...
function animateResultCards() {
    const resultCards = document.querySelectorAll('.metrikk-card, .comparison-card, .order-form-section');
...
function handleShowEstimate() {
    ...
    setButtonLoadingState(elements.showEstimateBtn, true);
    ...
    setTimeout(() => {
        ...
        setButtonLoadingState(elements.showEstimateBtn, false);
...
function initializeCalculator() {
    ...
    if (elements.showEstimateBtn) {
        elements.showEstimateBtn.addEventListener('click', handleShowEstimate);
    }
...
function init() {
    elements = {
        ...
        showEstimateBtn: document.getElementById('showEstimateBtn'),
